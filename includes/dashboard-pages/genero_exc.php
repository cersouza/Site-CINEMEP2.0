<?php 
    ...
    {
        $q = "delete from genero where gen_codigo=$id";
            
        $r = @mysqli_query($dbc, $q);
        if ($r)
        {
            echo "<meta HTTP-EQUIV='refresh' CONTENT='0;URL=genero_menu.php'>";
        } else {
...
<div class="container">
	<div class="row">
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<h1 class="page-header">Exclusão de Genero</h1>	
			<?php
				if	(isset($erro))
			...
			<form method="POST" action="genero_exc.php">
				...
				<div id="actions" align="right">
					<a class="btn btn-default" href="genero_menu.php">Fechar sem Excluir</a>
