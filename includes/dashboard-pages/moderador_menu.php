<?php 
	...
	if 	(isset($_GET['p']) && is_numeric($_GET['p']))
	{
		...
		$sql = "SELECT COUNT(mod_codigo) FROM moderador WHERE mod_nome like '%$where%'";
	...
	$q = "SELECT mod_codigo, mod_nome, mod_usuario FROM moderador 
		  WHERE mod_nome like '%$where%' ORDER BY $order_by
		  LIMIT $inicio, $exiba";
